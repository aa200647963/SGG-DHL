...
class ROIRelationHead(torch.nn.Module):
    ...
    def forward(self, features, proposals, targets=None, logger=None):
        ...
        loss_relation, loss_refine, loss_ce = self.loss_evaluator(proposals, rel_labels, relation_logits, refine_logits, add_data)
        ...
        if self.cfg.MODEL.ATTRIBUTE_ON and isinstance(loss_refine, (list, tuple)):
            ...
            output_losses = dict(loss_rel=loss_relation, loss_refine_obj=loss_refine, loss_ce=loss_ce)
